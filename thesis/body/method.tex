...
在模拟中，放射源、准直器、衰减器和探测器的集合构造与图\ref{fig:hopkins}几乎相同，但使用点源代替论文\cite{hopkins_linear_2012}中的半径为 $1.27\si{cm}$ 的片状放射源。在模拟中，因为不受到天然放射源的能量只能取特定的分离值的限制，$\gamma$ 射线能量可以采取任意值。
